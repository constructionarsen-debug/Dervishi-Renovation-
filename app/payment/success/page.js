...
export const metadata = { title: 'Pagesa u krye' };
...
export default function PaymentSuccess() {
  return (
    <div className="mx-auto max-w-2xl rounded-[2rem] border border-black/10 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-gray-900">
      <h1 className="text-2xl font-extrabold">Pagesa u krye</h1>
      <p className="mt-3 text-sm text-gray-600 dark:text-gray-300">
        Faleminderit! Nëse pagesa u konfirmua, do të merrni email me udhëzime.
      </p>
