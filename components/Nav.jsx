  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="relative flex items-center px-6 py-4 rounded-full bg-white/20 dark:bg-zinc-900/50 backdrop-blur-2xl border border-white/30 dark:border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.15)] dark:shadow-[0_10px_40px_rgba(0,0,0,0.6)]">
          {/* Logo */}
            ...
            <div className="hidden md:flex items-center gap-3">
              {status === "authenticated" && session?.user ? (
                <>
                  ...
                  <Link
                    href="/profile"
                    className="p-2 rounded-xl bg-white/40 dark:bg-zinc-800/40 border border-white/20 dark:border-white/10 hover:scale-105 transition"
                  >
                    <User size={18} />
                  </Link>
